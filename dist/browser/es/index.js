...
var Regionist = /*#__PURE__*/function () {
  ...
  _createClass(Regionist, [{
    ...
    value: function isCountryChanged() {
      return _classPrivateFieldGet(this, _prev).country != this.country && typeof this.country == 'string';
    }
  }, {
    key: "isTimezoneChanged",
    value: function isTimezoneChanged() {
      return _classPrivateFieldGet(this, _prev).timezone != this.timezone && typeof this.timezone == 'string';
    }
  }, {
    ...
    value: function findNativeLanguage() {
      ...
      var possibleNativeLanguages = _filterInstanceProperty(languagesWithinhNavigator).call(languagesWithinhNavigator, function (l) {
        return _indexOfInstanceProperty(languagesWithinCountry).call(languagesWithinCountry, l) !== -1;
      });
    ...
    value: function guessCountry() {
      ...
      var countryMatches = _filterInstanceProperty(countriesWithinSameTimezone).call(countriesWithinSameTimezone, function (country) {
        return _indexOfInstanceProperty(countriesWithinNavigator).call(countriesWithinNavigator, country) !== -1;
      });
...
export { callingCodes, countryLanguages, currencyCodes, regionist, timezones };
